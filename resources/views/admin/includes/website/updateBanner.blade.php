        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Cập nhật banner: </h2>
                    </div>
                    ...
                    <form action="{{ route('updateBanner', ['id'=>$banner['id']]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <div class="image-input1">
                                    ...
                                    <img src="{{$banner['image']}}" class="image-preview1" style="max-width:50vw">
                        ...
                        <a href="{{ route('updateBanner', ['id'=>$banner['id']]) }}"><button type="submit" class="btn btn-primary">
                                Cập nhật</button></a>
                    </form>
