        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Cập nhật giới thiệu: </h2>
                    </div>

                    <form action="{{asset('admin/website/update-introduce/'.$introduce[0]['id'] )}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-input2">
                                <input type="file" accept="image/*" id="imageInput2" name="image" value="{{$introduce[0]['image']}}">
                                <img  class="image-preview2" style="max-width:100px" src="{{$introduce[0]['image']}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="post_content" id="content" rows="5" class="form-control ">{!! $introduce[0]['content'] !!}</textarea>
                        </div>
