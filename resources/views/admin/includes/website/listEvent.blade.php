        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Danh sách sự kiện: </h2>
                        <a class="col-md-2 col-12" href="{{ asset('admin/website/them-moi-su-kien') }}">
                    ...
                    <table class="table table-striped table-responsive">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col" >Tên</th>
                                <th scope="col" class="none">Nội dung</th>
                                <th scope="col" class="text-center none">Ảnh</th>
                                <th scope="col" class="text-center none">Video </th>
                                <th scope="col" class="text-center">Sự kiện nổi bật</th>
                                <th scope="col">Thao tác</th>
                            </tr>
                        </thead>
                        <tbody>
                            {{-- {{ dd($listEvent) }} --}}
                            @foreach ($listEvent as $index => $event)
                                <tr>
                                    <th scope="row" style="vertical-align: middle ">{{ $index + 1 }}</th>
                                    <td  style="vertical-align: middle ">
                                            {{ $event['title'] }}</td>
                                    <td class="cutText none" style="vertical-align: middle ">{!! $event['content'] !!}</td>
                                    <td class="products none" style="vertical-align: middle "><img
                                        src="{{ $event['image'] }}">
                                    </td>
                                    <td class="none" style="vertical-align: middle; display: position ">
                                    ...
                                    <td style="vertical-align: middle ">
                                        <a href="{{ asset('admin/website/chi-tiet-su-kien/' . $event['id']) }}"
                                    ...
                                    <div class="modal fade" id="delete{{ $event['id'] }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Tên: {{ $event['title'] }}</div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-dismiss="modal">Huỷ</button>
                                                    <a class="btn btn-danger"
                                                        href="{{ asset('admin/website/delete-event/' . $event['id']) }}">Xoá</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
