        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Thêm mới ảnh: </h2>
                    </div>
                    ...
                    <form action="{{ route('addBanner') }}" method="post" enctype="multipart/form-data">
                        ...
                        <
                            <div class="form-group">
                                ...
                                <div class="image-input1">
                                    ...
                                    <img src="" class="image-preview1" style="max-width:50vw">
                        ...
                        <a href="{{ route('addBanner') }}"><button type="submit" class="btn btn-primary">Thêm
                                mới</button></a>
                    </form>
