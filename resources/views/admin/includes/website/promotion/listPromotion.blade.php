        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Danh sách khuyến mãi: </h2>
                        <a class="col-md-2 col-12" href="{{ asset('admin/website/them-moi-khuyen-mai') }}">
                    ...
                    <table class="table table-striped ">
                        ...
                        <tbody>
                            @foreach ($listPromotion as $index => $item)
                                <tr>
                                    ...
                                    <td class="" style="vertical-align: middle; display: position ">
                                        <p><a href="{{$item['video']}}">{{$item['video']}}</a></p>
                                        @if($item['video']!=null)
                                        @php
                                        $linkvd = $item['video'];
                                    ...
                                    <td style="vertical-align: middle ">
                                        <a href="{{ asset('admin/website/chi-tiet-khuyen-mai/' . $item['id']) }}"
                                    ...
                                    <div class="modal fade" id="delete{{ $item['id'] }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Tiêu đề khuyến mãi: {{ $item['title'] }}</div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-dismiss="modal">Huỷ</button>
                                                    <a class="btn btn-danger"
                                                        href="{{ asset('admin/website/xoa-khuyen-mai/' . $item['id']) }}">Xoá</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
