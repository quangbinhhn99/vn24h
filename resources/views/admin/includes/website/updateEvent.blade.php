        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Cập nhật sự kiện: </h2>
                    </div>
                    ...
                    <form action="{{ route('updateEvent', ['id'=>$event['id']]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="image-input1">
                                    ...
                                    <img src="{{$event['image']}}" class="image-preview1" style="max-width:100px">

                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content">Sự kiện nổi bật: </label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="isHot" id="inlineRadio1"
                                    value="1" @if ($event['isHot']==1) {{ "checked" }}
                                    @endif>
                                <label class="form-check-label" for="inlineRadio1">Có</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="isHot" id="inlineRadio2"
                                    value="0" @if ($event['isHot']==0) {{ "checked" }}
                                    @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="video" name="video" placeholder="Link video ..."
                                required value="{{ $event['video']}}">

                        </div>
                        <div class="form-group">
                            <label for="content">Nội dung: </label><br>
                            <textarea name="post_content" id="content" rows="5" class="form-control "
                                placeholder="Nội dung sự kiện">{{$event['content']}}</textarea>
                        </div>



                        <a href="{{ url()->previous() }}" class="btn btn-secondary">Quay lại</a>
                        <a href="{{ route('updateEvent', ['id'=>$event['id']]) }}"><button type="submit" class="btn btn-primary">
                                Cập nhật</button></a>
                    </form>
