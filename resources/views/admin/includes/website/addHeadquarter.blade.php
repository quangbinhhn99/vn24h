        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Thêm mới văn phòng trụ sở: </h2>
                    </div>

                  
                    <form action="{{ route('addHeadquarter') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="address"
                                    placeholder="Địa chỉ trụ sở ..." required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="link_map"
                                placeholder="Link google map ..." required>
                        </div>
                        ...
                        <a href="{{ route('addHeadquarter') }}"><button type="submit" class="btn btn-primary">Thêm
                                mới</button></a>
                    </form>
