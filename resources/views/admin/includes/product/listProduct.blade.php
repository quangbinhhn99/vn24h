        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h2 class="text-left col-md-10 col-12">Danh sách sản phẩm: </h2>
                        <a class="col-md-2 col-12" href="{{ asset('admin/san-pham/them-moi') }}">
                    ...
                    <table class="table table-striped table-responsive">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" class="none">Mô tả</th>
                                <th scope="col" class="none">Tầm nhìn chiến lược</th>
                        ...
                        <tbody>
                            ...
                            {{-- {{ dd($product)}} --}}
                                <tr>
                                    ...
                                    <td class="cutText none" style="vertical-align: middle ">{!! $product['description'] !!}
                                    </td>
                                    <td style="vertical-align: middle; width:30% " class="none">
                                        {!! $product['strategic_vision'] !!}</td>
                                    ...
                                    <td style="vertical-align: middle ">
                                        <a href="{{ asset('admin/san-pham/chi-tiet/' . $product['id']) }}"
                                            class="btn btn-info btn-circle btn-sm">
                                            <i class="fas fa-info-circle"></i>
                                        </a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger"
                                                        href="{{ asset('admin/san-pham/xoa/' . $product['id']) }}">Xoá</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
